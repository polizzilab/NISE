...
### For a complete example design campaign (generated a $K_d = 80 \pm 40$ picoMolar Apixaban binder), check out the contents of [example_design_campaign](./example_design_campaign/)
